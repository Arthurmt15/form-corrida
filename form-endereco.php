...
<div class="col-md-8">
  ...
  <input type="text" name="logradouro" id="logradouro" class="form-control" required maxlength="150">
</div>
<div class="col-md-3">
  <label class="form-label">Número *</label>
  <input type="text" name="numero" class="form-control" required maxlength="10">
</div>
<div class="col-md-5">
  <label class="form-label">Complemento</label>
  <input type="text" name="complemento" class="form-control" maxlength="100" placeholder="Apto, Bloco, Sala">
</div>
<div class="col-md-4">
...
<div class="col-md-4">
  ...
  <input type="text" name="uf" id="uf" class="form-control" required maxlength="2" placeholder="SP">
</div>
