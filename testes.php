...
check('cpf com letra rejeitado', !cpf_cnpj_ok('529a8224725'));
check('mascara cpf', mascarar_doc('52998224725') === '529.***.***-25');
check('celular 11 dígitos', celular_ok('(11) 99999-9999'));
check('fixo 10 dígitos', celular_ok('(11) 3333-4444'));
check('celular com letra rejeitado', !celular_ok('(11) 9999a-9999'));
check('celular curto rejeitado', !celular_ok('12345'));
